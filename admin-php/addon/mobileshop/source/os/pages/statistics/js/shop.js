			...
			this.$api.sendRequest({
				...
				success: res => {
					if (res.code >= 0) {
						...
						this.add_goods_count.categories = timeTemp;
						this.visit_count.categories = timeTemp;
						this.collect_goods.categories = timeTemp;
						this.goods_pay_count.categories = timeTemp;
						this.collect_shop.categories = timeTemp;
						this.order_pay_count.categories = timeTemp;
						this.order_total.categories = timeTemp;
