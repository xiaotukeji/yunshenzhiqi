	...
	<view class="order-detail-wrap">
		...
		<view class="footer-wrap">
			<view class="container">
				...
				<button v-if="orderDetail.order_type == 2 && orderDetail.order_status == 2" type="primary" size="mini" @click.stop="storeOrderTakedeliveryFn(orderId)">提货</button>
			</view>
		</view>
