<template>
	<view class="order-detail-wrap">
		...
		<view class="block-wrap">
			...
			<view class="order-cell" v-if="orderDetail.virtual_goods && orderDetail.virtual_goods.total_verify_num >= 0">
				<text class="tit">核销总次数：</text>
				<view class="box">{{ orderDetail.virtual_goods.total_verify_num }}</view>
			</view>
			<view class="order-cell" v-if="orderDetail.virtual_goods && orderDetail.virtual_goods.total_verify_num >= 0">
				<text class="tit">核销剩余次数：</text>
				<view class="box">{{ orderDetail.virtual_goods.total_verify_num - orderDetail.virtual_goods.verify_num }}</view>
			</view>
			<view class="order-cell">
			...
			<view class="order-cell" v-if="orderDetail.pay_time > 0">
