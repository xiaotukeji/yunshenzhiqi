	...
	<view class="order-detail-wrap">
		...
		<view class="block-wrap">
			...
			<view class="order-cell">
				...
				<view class="box">{{ orderDetail.buyer_ask_delivery_time_str }}</view>
			</view>
		...
		<view class="block-wrap tit-auto" v-if="orderDetail.package_list">
			...
			<view class="order-cell">
				<text class="tit">配送时间：</text>
				<view class="box align-right">{{ $util.timeStampTurnTime(orderDetail.package_list.delivery_time) }}</view>
			</view>
		</view>
