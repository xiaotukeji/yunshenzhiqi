		...
		<view class="content">
			...
			<view class="list">
				<view class="item-wrap" @click="$util.redirectTo('/pages/my/shop/config')">
					<view class="info">
						<image class="img" :src="$util.img('public/uniapp/shop_uniapp/my/store.png')" mode="aspectFit"></image>
						<text>店铺信息</text>
					</view>
				...
				<view class="item-wrap" @click="$util.redirectTo('/pages/my/shop/contact')">
					<view class="info">
						<image class="img" :src="$util.img('public/uniapp/shop_uniapp/my/address.png')" mode="aspectFit"></image>
						<text>联系地址</text>
					</view>
					<text class="iconfont iconright"></text>
				</view>
				<view class="item-wrap" @click="$util.redirectTo('/pages/my/user/user')">
					<view class="info">
						<image class="img" :src="$util.img('public/uniapp/shop_uniapp/my/member.png')" mode="aspectFit"></image>
						<text>用户管理</text>
					</view>
					<text class="iconfont iconright"></text>
				</view>
				<view class="item-wrap" @click="$util.redirectTo('/pages/login/modify_pwd')">
					<view class="info">
						<image class="img" :src="$util.img('public/uniapp/shop_uniapp/my/password.png')" mode="aspectFit"></image>
						<text>修改密码</text>
					</view>
					<text class="iconfont iconright"></text>
				</view>
				<view class="item-wrap" v-if="addonIsExit.store" @click="$util.redirectTo('/pages/property/settlement/list_store')">
					<view class="info">
						<image class="img" :src="$util.img('public/uniapp/shop_uniapp/index/store_jiesuan.png')" mode="aspectFit"></image>
						<text>门店结算</text>
					</view>
					<text class="iconfont iconright"></text>
				</view>
				<!-- <view class="item-wrap" @click="$util.redirectTo('/pages/property/settlement/list')">
					<view class="info">
						<image class="img" :src="$util.img('public/uniapp/shop_uniapp/index/shop_jiesuan.png')" mode="aspectFit"></image>
						<text>店铺结算</text>
					</view>
					<text class="iconfont iconright"></text>
				</view> -->
				<!-- <view class="item-wrap" @click="$util.redirectTo('/pages/property/withdraw/list')">
					<view class="info">
						<image class="img" :src="$util.img('public/uniapp/shop_uniapp/index/tixian.png')" mode="aspectFit"></image>
						<text>提现记录</text>
					</view>
					<text class="iconfont iconright"></text>
				</view> -->
				<view class="item-wrap" @click="$util.redirectTo('/pages/verify/index')">
					<view class="info">
						<image class="img" :src="$util.img('public/uniapp/shop_uniapp/index/verify_peo.png')" mode="aspectFit"></image>
						<text>核销台</text>
					</view>
					<text class="iconfont iconright"></text>
				</view>
