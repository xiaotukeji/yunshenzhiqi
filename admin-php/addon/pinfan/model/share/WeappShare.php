...
class WeappShare extends WeappShareBase
{
    protected $config = [
        [
            'title' => '拼团返利列表',
            'config_key' => 'WEAPP_SHARE_CONFIG_PINFAN_LIST',
            'path' => ['/pages_promotion/pinfan/list'],
            'method_prefix' => 'pinfanList',
        ],
    ];
     ...
     * @return array
     */
    protected function pinfanListShareData($param)
    {
        //获取和替换配置数据
        $config_data = $this->pinfanListShareConfig($param);
     ...
     * @return array
     */
    protected function pinfanListShareConfig($param)
    {
