...
layui.use(['form', 'layer'], function () {
	 ...
	 */
	$("body").off('click', '.express-area-list .area-btn').on('click', '.express-area-list .area-btn', function () {
	 ...
	 */
	$("body").off('click', '.express-area-list.all-area ul li .title-div .name-div').on('click', '.express-area-list.all-area ul li .title-div .name-div', function () {
		var li = $(this).parent().parent();
	 ...
	 */
	$("body").off("click", ".express-area-modal .add").on("click", ".express-area-modal .add", function () {
		// 找到新选中部分
	 ...
	 */
	$("body").off("click", ".express-area-modal .express-area-list.selected-area .area-delete").on("click", ".express-area-modal .express-area-list.selected-area .area-delete", function () {
	 ...
	 * 保存操作
	 */
	$("body").off("click", ".express-save-btn").on("click", ".express-save-btn", function () {
	 ...
	 * 取消操作
	 */
	$("body").off("click", ".express-area-modal .cancel-btn").on("click", ".express-area-modal .cancel-btn", function () {
		layer.close(layer_index);
	});
		...
		$.ajax({
			...
			success: function (res) {
				layer.msg(res.message, {}, function () {
					if (res.code == 0) {
						location.hash = ns.hash('shop/express/template');
					}
				});
				submit_flag = false;
			}
	 ...
	 * 展开与收起 思路为先改变数据 再重新渲染
	 */
	$("body").off('click', '.shipping-area-list .area-btn').on('click', '.shipping-area-list .area-btn', function () {
		var li = $(this).parent().parent();
		var extended = li.attr('data-extended');
		var level = li.attr('data-level');
		var pid = li.attr('data-pid');
	 ...
	 * 选中与取消 思路同展开与收起 也是先改变数据 再重新渲染
	 */
	$("body").off('click', '.shipping-area-list.all-area ul li .title-div .name-div').on('click', '.shipping-area-list.all-area ul li .title-div .name-div', function () {
	 ...
	 * 将选中部分添加到已选中 思路为先遍历和处理数据 再渲染两边的列表
	 */
	$("body").off("click", ".shipping-area-modal .add").on("click", ".shipping-area-modal .add", function () {
	 ...
	 * 思路：相当于是执行了两步操作 1：选中 2：反向添加
	 */
	$("body").off("click", ".shipping-area-modal .shipping-area-list.selected-area .area-delete").on("click", ".shipping-area-modal .shipping-area-list.selected-area .area-delete", function () {
	 ...
	 * 保存操作
	 */
	$("body").off("click", ".shipping-save-btn").on("click", ".shipping-save-btn", function () {
		layer.close(layer_index);
	 ...
	 * 取消操作
	 */
	$("body").off("click", ".shipping-area-modal .cancel-btn").on("click", ".shipping-area-modal .cancel-btn", function () {
		layer.close(layer_index);
	});
