<template>
	...
	<view class="page" :style="{ background: bgColor }">
		<mescroll-uni @getData="getData" ref="mescroll" :size="10" v-if="addonIsExist.groupbuy">
			<block slot="list">
				<view class="ns-adv"><ns-adv keyword="NS_GROUPBUY"></ns-adv></view>
					...
					<view class="goods-item margin-bottom" v-for="(item, index) in dataList" :key="index">
						...
						<view class="info-wrap">
							...
							<view class="lineheight-clear">
								原价：
								<text class="delete-price font-size-activity-tag color-tip price-font">
							...
							<view class="pro-info">
								...
								<view @click="toDetail(item)"><button type="primary" size="mini" class="mini">去团购</button></view>
							</view>
						</view>
					</view>
				</view>
				<view v-if="dataList.length == 0">
					<ns-empty text="暂无团购" textColor="#fff" :isIndex="false"></ns-empty>
				</view>
			</block>
		</mescroll-uni>
		<!-- 悬浮按钮 -->
