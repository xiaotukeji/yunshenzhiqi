	...
	<view>
		...
		<goods-detail-view :goodsSkuDetail="goodsSkuDetail" ref="goodsDetailView">
			...
			<template v-slot:price>
				<view v-if="goodsSkuDetail.discountTimeMachine" class="goods-promotion">
					<view class="price-info">
						<view class="icon-box"><text class="iconfont icon-zhuantihuodong"></text></view>
				...
				<view class="group-wrap padding-top">
					<view class="goods-module-wrap">
						...
						<view class="market-price-wrap" v-if="goodsSkuDetail.market_price_show && (goodsSkuDetail.market_price > 0 || goodsSkuDetail.price > goodsSkuDetail.topic_price)">
							...
							<text class="money price-font" v-else-if="goodsSkuDetail.price > goodsSkuDetail.topic_price">{{ goodsSkuDetail.price }}</text>
						</view>
			...
			<template v-slot:articipation>
				...
				<view class="goods-detail-tab rule-wrap" v-if="goodsSkuDetail.remark">
					<view class="detail-tab"><view class="tab-item">活动内容</view></view>
				...
				<ns-goods-action :safeArea="isIphoneX">
					<template v-if="goodsSkuDetail.goods_state == 1">
						...
						<ns-goods-action-button
							...
							v-else
							class="goods-action-button active1"
							text="立即抢购"
							@click="topic"
						/>
					</template>
