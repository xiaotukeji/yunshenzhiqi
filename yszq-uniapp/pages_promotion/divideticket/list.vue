                ...
                <view class="coupon-listone" v-if="list.length>0">
                    <view class="item" v-for="(item, index) in list" :key="index" @click="toGoodsList(item)">
                        <view class="item-left">
                            <view class="item-flex">
                                <view class="item-base">
                                    ...
                                    <image v-else :src="$util.img('public/uniapp/divideticket/coupon_list_img.png')" mode="aspectFit"/>
                                </view>
                        ...
                        <view class="item-right">
                            ...
                            <view class="tag" @click.stop="toGoodsList(item)" v-if="item.g_status==1">去查看</view>
