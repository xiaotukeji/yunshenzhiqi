	...
	<view class="star-container">
		<view class="star-view star-view" style="display: flex;align-items: center;height: 36rpx; overflow: hidden;margin-top:2rpx;">
			<view class="star-icon-con">
				<view @tap="evaluateTap(item, index)" :class="item == 3 ? 'iconfont star-icon-item-font iconai65' : item == 1 ? 'iconfont star-icon-item-font iconwujiaoxing1' : ''" v-for="(item, index) in starArr" :key="index"></view>
			</view>
		</view>
	</view>
</template>
