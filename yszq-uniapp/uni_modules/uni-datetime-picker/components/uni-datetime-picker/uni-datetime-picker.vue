	...
	<view class="uni-date">
			...
			<slot>
				<view class="uni-date-editor--x" :class="{'uni-date-editor--x__disabled': disabled,'uni-date-x--border': border}">
					...
					<view v-else class="uni-date-x uni-date-range">
						<uni-icons type="calendar" color="#e1e1e1" size="22"></uni-icons>
						<input class="uni-date__x-input t-c" type="text" v-model="range.startDate" :placeholder="startPlaceholderText" :disabled="true" />
						<slot>
							<view>{{rangeSeparator}}</view>
						</slot>
						<input class="uni-date__x-input t-c" type="text" v-model="range.endDate" :placeholder="endPlaceholderText" :disabled="true" />
					</view>
		...
		<view v-if="!isPhone" ref="datePicker" v-show="popup" class="uni-date-picker__container">
			<view v-if="!isRange" class="uni-date-single--x" :style="popover">
				...
				<calendar ref="pcSingle" :showMonth="false" :start-date="caleRange.startDate" :end-date="caleRange.endDate" :date="defSingleDate" @change="singleChange" style="padding: 0 8px;" />
